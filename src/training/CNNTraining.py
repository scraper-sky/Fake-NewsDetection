...
from src.data.dataset import CNNDataset
...
def get_data_loaders():
    ...
    train_dataset = CNNDataset(train_set['combined'].tolist(), train_set['label'].tolist(), TOKENIZER)
    dev_dataset = CNNDataset(dev_set['combined'].tolist(), dev_set['label'].tolist(), TOKENIZER)
    test_dataset = CNNDataset(test_set['combined'].tolist(), test_set['label'].tolist(), TOKENIZER)
