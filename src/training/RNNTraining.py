...
from src.data.dataset import RNNDataset
...
def get_data_loaders():
    ...
    train_dataset = RNNDataset(train_set['combined'].tolist(), train_set['label'].tolist(), TOKENIZER)
    dev_dataset = RNNDataset(dev_set['combined'].tolist(), dev_set['label'].tolist(), TOKENIZER)
    test_dataset = RNNDataset(test_set['combined'].tolist(), test_set['label'].tolist(), TOKENIZER)
